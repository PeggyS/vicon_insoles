...
% involved fsr
line(app.UIAxes_inv_insole, i_time, inv_composite_force_est,...
...
% uninvolved fsr
line(app.UIAxes_uninv_insole, i_time, uninv_composite_force_est,...
	'Tag', 'line_uninv_fsr_est')

% link the xlimits of all the axes. Save in figure user data
app.HeelMarkerInsolesUIFigure.UserData.ax_link = linkprop([app.UIAxes_inv_heel, app.UIAxes_inv_insole, ...
	app.UIAxes_uninv_heel, app.UIAxes_uninv_insole], 'XLim');
